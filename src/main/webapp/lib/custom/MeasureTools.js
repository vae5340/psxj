...
define([
    ...
    return declare(_WidgetBase, {
        ...
        _initalToolbar: function () {
            ...
            query("#tool_cexian").on("click", lang.hitch(this, this._startMeasureDistance));
            query("#tool_cemian").on("click", lang.hitch(this, this._startMeasureArea));
        },
        ...
        _startMeasureDistance: function () {
        	//鼠标样式
        	this.defaults.map.setMapCursor("url(plugins/hplus/images/cexian_btn_pointer.png),auto");
        ...
        _startMeasureArea: function () {
        	//鼠标样式
        	this.defaults.map.setMapCursor("url(plugins/hplus/images/cemian_btn_hover.png),auto");
            this._clearMapMouseClickEvent();
			isClickQuery=false;
            this._measureLayer.clear();
            this.toolbar.deactivate();
