$(function() {
    ...
    function c() {
    	//点击三级菜单关闭伸缩
    	seperatorClose();
    	layer.closeAll('iframe'); //打开另一页面关闭全部弹出框
        ...
        if (k) {
            ...
            var seto=o;
            if(o.indexOf("?")>0){
            	seto+="&titleName="+encodeURIComponent(l);
            } else {
            	seto+="?titleName="+encodeURIComponent(l);
            }
            //原本的height="100%"
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height=100%" src="' + seto + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
