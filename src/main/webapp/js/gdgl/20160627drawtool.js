		...
		$.ajax({
			...
			success: function(data){
				...
				$.each(obj,function(index){
					...
					var tr = "<tr onclick='drawTool.dingwei("+obj[index].attributes.OBJECTID+")'>"+
						"<td>"+obj[index].attributes.StartPoint+"</td>"+
						"<td>"+obj[index].attributes.EndPoint+"</td>"+
						"<td>"+obj[index].attributes.RoadName+"</td>"+
						"<td>"+obj[index].attributes.StartDeep+"</td>"+
						"<td>"+obj[index].attributes.EndDeep+"</td>"+
						"</tr>";
					$("#table").append(tr);
				});
			},
