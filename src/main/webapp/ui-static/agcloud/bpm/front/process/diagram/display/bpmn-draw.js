...
//augurit:新增根据当前节点状态变换节点填充颜色
function _bpmnGetActivityFillColor(element, defaultColor)
{
    var activityFillColor;
    if(element.current) {
        activityFillColor = CURRENT_ACTIVITY_FILL_COLOR;
    } else if(element.completed) {
        activityFillColor = COMPLETED_ACTIVITY_FILL_COLOR;
    } else {
        activityFillColor = defaultColor;
    }
...
function _drawTask(element)
{
    ...
    var fillColor = _bpmnGetActivityFillColor(element, ACTIVITY_FILL_COLOR);
