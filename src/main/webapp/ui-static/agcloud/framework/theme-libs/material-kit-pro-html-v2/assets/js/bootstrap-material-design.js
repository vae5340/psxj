        ...
        var Dropdown =
            ...
            function() {
                ...
                _proto.toggle = function toggle() {
                    ...
                    //augurit:解决退出下拉框和主题切换下拉框冲突的问题；
                    // 策略为：判定为退出下拉框才去加对应的show样式并且加入了“dropdown-menu-exit”、“dropdown-nav-item”两个ID，用于精准拿到对应的下拉框
                    if(parent.className=='dropdown nav-item'){
                        ...
                        $('#dropdown-menu-exit').addClass(ClassName.SHOW + " " + ClassName.SHOWING);
                        $('#dropdown-nav-item').addClass(ClassName.SHOW);
