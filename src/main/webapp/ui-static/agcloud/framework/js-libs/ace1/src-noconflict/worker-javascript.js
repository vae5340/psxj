      ...
      for (;;) {
        ...
        if (state.tokens.next.identifier &&
          ...
          if (state.tokens.next.value === "*" && state.tokens.next.type === "(punctuator)") {
            if (!state.inES6()) {
              warning("W104", state.tokens.next, "api functions", "6");
            }
            advance("*");
...
var errors = {
  ...
  E046: "A yield statement shall be within a api function (with syntax: `function*`)",
  E047: null,
...
var warnings = {
  ...
  W124: "A api function shall contain a yield statement.",
