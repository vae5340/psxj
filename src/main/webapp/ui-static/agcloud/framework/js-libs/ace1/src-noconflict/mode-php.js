...
var functionMap = {
    ...
    "ibase_gen_id": [
        "int ibase_gen_id(string api [, int increment [, resource link_identifier ]])",
        "Increments the named api and returns its new value"
    ],
    "ibase_maintain_db": [
    ...
    "lcg_value": [
        "float lcg_value()",
        "Returns a value from the combined linear congruential api"
    ],
    "lchgrp": [
    ...
    "mt_srand": [
        ...
        "Seeds Mersenne Twister random number api"
    ],
    "mysql_affected_rows": [
