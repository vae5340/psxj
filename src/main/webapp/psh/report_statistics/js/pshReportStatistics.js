...
var ProblemTable=function(){
	...
	ProblemTable.Init=function(){
		$("#problemTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/psxj/pshDischarger/statisticsForArea',
			rowStyle:"rowStyle",
			cache:false,
...
var unitTable=function(){
	...
	unitTable.Init=function(){
		$("#unitTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/psxj/pshDischarger/statisticsForUnit',
			rowStyle:"rowStyle",
			cache:false,
			pagination:false,//屏蔽分页
			dataType:'json',
...
var LackAddTable=function(){
	...
	LackAddTable.Init=function(){
		$("#lackAddTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/psxj/pshDischarger/statisticsForPerson',
			method: 'get',
			rowStyle:"rowStyle",
			cache:false,
	...
	LackAddTable.queryParms=function(params){
		...
		if( startTimeStr == null || startTimeStr=="" || startTimeStr == " " || startTimeStr == undefined ){
