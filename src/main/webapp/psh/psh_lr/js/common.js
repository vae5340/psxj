...
function downloadFile(sysFileId) {
    var url = "/psxj/sewerageUserAttachment/downloadFile?id="+sysFileId;
    window.location.href=url;
}

function deleteFile(sysFileId,type) {
    var url = "/psxj/sewerageUserAttachment/deleteById";
...
function refreshFilelist(type){
    $.ajax({
        type:'post',
        url:"/psxj/sewerageUserAttachment/getByTypeAndSewerageUserId",
