	...
	Table.Init=function(){
		...
		    pageList: [10, 25, 50, 100],
			...
			columns:[
				...
				{field:'area',title:'所属区域',visible:true,align:'center'},
				...
				{field:'hasCert3',title:'排水许可证',visible:true,align:'center',formatter: format_yw},
				{field:'hasCert4',title:'排污许可证',visible:true,align:'center',formatter: format_yw},
				{field:'hasCert1',title:'营业执照',visible:true,align:'center',formatter: format_yw},
				...
				{title:'操作',visible:true,align:'center',formatter: format_oper,width:120}]
		});
	},
...
function exportExcel(){
	...
	if(town != "")
		where +="&town="+town; 
	var dischargerType1 =$("#dischargerType1").val()?$("#dischargerType1").val():""
	if(dischargerType1 != "")
		where +="&dischargerType1="+dischargerType1; 
	var childCode = $("#childCode").val();
	if(childCode != "")
		where +="&childCode="+childCode; 
	var  hasCert1= $("#hasCert1").val();
	if(hasCert1 != "")
		where +="&hasCert1="+hasCert1; 
	var  hasCert3= $("#hasCert3").val();
	if(hasCert3 != "")
		where +="&hasCert3="+hasCert3; 
	var  hasCert4= $("#hasCert4").val();
	if(hasCert4 != "")
		where +="&hasCert4="+hasCert4; 
	...
	window.location.href="/agsupport_swj/psh-discharger!exportExcel.action?area="+area+where;
}