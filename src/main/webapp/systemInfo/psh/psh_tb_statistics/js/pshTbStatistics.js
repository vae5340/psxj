...
var oneTable=function(){
	...
	oneTable.Init=function(){
		$("#oneTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/agsupport_swj/statistics!getSbedInf.action',
			method: 'get',
			rowStyle:"rowStyle",
			cache:false,
			pagination:true,
...
var twoTable=function(){
	...
	twoTable.Init=function(){
		$("#twoTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/agsupport_swj/statistics!getInstalledInf.action',
			method: 'get',
			rowStyle:"rowStyle",
			cache:false,
			pagination:true,
...
var threeTable=function(){
	...
	threeTable.Init=function(){
		$("#threeTable").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/agsupport_swj/statistics!pshRyStatistics.action',
			method: 'get',
			rowStyle:"rowStyle",
			cache:false,
			pagination:true,
...
function loadDataEacha11(temp){
	var data = loadEachr.loadData("/agsupport_swj/statistics!getSbedByArea.action",temp? temp:null);
...
function loadDataEacha12(orgName){
	...
	var data = loadEachr.loadData("/agsupport_swj/statistics!getSbedByUnit.action",temp? temp:null);
...
function loadDataEacha21(temp){
	var data = loadEachr.loadData("/agsupport_swj/statistics!getInstalledByArea.action",temp? temp:null);
...
function loadDataEacha22(orgName){
	...
	var data = loadEachr.loadData("/agsupport_swj/statistics!getInstalledByUnit.action",temp? temp:null);
	var option_data= [];
	var option_x= [];
	var option_data0= [];
	if(data){
		...
		options22.series[0].data=option_data0;//给Y轴第一柱子赋值
...
function loadDataEacha31(temp){
	var data = loadEachr.loadData("/agsupport_swj/statistics!pshQuStatistics.action",temp? temp:null);
...
function loadDataEacha32(orgName){
	...
	var data = loadEachr.loadData("/agsupport_swj/statistics!pshZjStatistics.action",temp? temp:null);
	var option_data= [];
	var option_x= [];
	if(data){
		for(var i in data.rows){
