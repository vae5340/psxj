...
var Table=function(){
	...
	Table.Init=function(){
		$("#table").bootstrapTable({
			method: 'get',
			toggle:"tableCell",
			url:'/agsupport_swj/ex-gongan77-dz-mpdy!getMpList.action',//
			rowStyle:"rowStyle",
			cache:false,
			pagination:true,
			dataType:'json',
		...
		    pageList: [10, 25, 50, 100],
			...
			columns:[
				...
				{field:'ssjlxdm',title:'街路巷',visible:true,align:'center'},
				{field:'sssqcjwhdm',title:'社区居委会',visible:true,align:'center'},
				{field:'ssxzjddm',title:'乡政街',visible:true,align:'center'},
				{field:'ssxzqhdm',title:'行政区',visible:true,align:'center'},
...
function addShow(ssxzqh,ssxzjd,sssqcjwh,ssjlx,mpwzhm,sfdtl,SGuid){
	layer.open({
		...
		maxmin: true,
		btn:['保存','取消'],
		content: ['/awater_swj/psh/psh_lr/pshLrInput.html?type=add&area='+ssxzqh+'&town='+ssxzjd+'&village='+sssqcjwh+'&street='+ssjlx+'&mph='+mpwzhm+'&sfdtl='+sfdtl+'&SGuid='+SGuid, 'yes'],
