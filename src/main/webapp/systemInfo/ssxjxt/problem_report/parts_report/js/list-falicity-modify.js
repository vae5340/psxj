    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[ 11, 13,12,7,26,20,10, 20, 13, 15, 17, 19, 20]
        }
    ]
};
$(function(){
    ...
    //$frame2.find("#mapInfo_content").load("../mapInfo/infoInput.html");
});
...
var Table=function(resultData){
	...
	//柱形图
	function columnView(){
		var myChar = echarts.init(document.getElementById('chartContainer'));
...
function goLocation(layerName,objId){
	...
	//console.log( parent.document.getElementById('map-frame').contentWindow);
}