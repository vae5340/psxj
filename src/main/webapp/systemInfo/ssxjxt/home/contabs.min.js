$(function() {
    ...
    function c() {
    	$('.leftDiv').stop(true,true).slideUp(0);
...
//					$('#leftMenu>li').eq(i).css("background-color","#8098b9");
				}
	          }, 100);
		});
    ...
    $("#tool-button-contracts").on("click", contracts);
    function contracts() {
    	$("#tool-button-expand").show();
    	$("#navbar-Menu").hide();
    	$("#page-wrapper").css("margin-left", "0px");
    	$("#content-tabs-button").css("margin-left", "70px");
    	$("#content-tabs-nav").css("margin-left", "110px");
    }
    $("#tool-button-expand").on("click", expand);
    function expand() {
    	$("#tool-button-expand").hide();
    	$("#navbar-Menu").show();
    	$("#page-wrapper").css("margin-left", "70px");
    	$("#content-tabs-button").css("margin-left", "0px");
    	$("#content-tabs-nav").css("margin-left", "40px");
    }
});