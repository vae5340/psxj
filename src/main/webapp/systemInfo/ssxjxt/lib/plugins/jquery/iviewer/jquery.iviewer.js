...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    options : {
        ...
        **/
        ui_disabled: false,
        /**
         * if true plugin add its turn right control,but The premise condition what ui_disabled is true
         **/
        ui_right: false,
        /**
    ...
    **/
    ...
    update_status_for_right: function()
    {
    	if(this.options.ui_right)
    	{
    		var percent = Math.round(100*this.img_object.display_height()/this.img_object.orig_height());
    		if(percent)
    		{
    ...
    **/
     ...
     *   create zoom buttons info box
     **/
    createui_right: function()
    {
    	var me=this;
    	$("<div>", { 'class': "iviewer_rotate_right iviewer_common iviewer_button" })
    	.bind('click',function(event){me.angle(90);return false;})
    	.appendTo(this.container);
    	
    	this.update_status_for_right(); //initial status update
    }
