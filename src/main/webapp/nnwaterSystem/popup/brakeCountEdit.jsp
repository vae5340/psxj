...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../../lib/jquery-easyui-1.4.5/themes/default/icon.css"/>
	<script type="text/javascript" src="../../lib/js/jquery.min.js"></script>
	<script type="text/javascript" src="../../lib/jquery-easyui-1.4.5/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="../../lib/jquery-easyui-1.4.5/locale/easyui-lang-zh_CN.js" charset="utf-8"></script>
	
	<script src="../../lib/highchart/js/highcharts.js"></script>
	<script src="../../lib/highchart/js/modules/exporting.js"></script>
	<script src="../../lib/highchart/HighchartsSet.js"></script>
   ...
   <body> 
  		<div class="easyui-layout" fit="true" style="background-color: #f4f0e0">
			<table>
				  	   ...
				  	   <div style="float: left;">
						  	...
						  	<div class="easyui-panel" data-options="doSize:false" style="width:510px;height:40px;margin-left: 3px;border-top:0px;"">
						  		...
						  		<div style="float: left;margin-left: 40px;margin-top: 5px;">
						  			<table border="0px;">
						  				<tr>
						  					<td width="40px;"><img src="/img/refresh.png" style="cursor:hand" alt="刷新" onclick="showData()" /></td>
						  				</tr>
						  			</table>	
						        </div>
						    </div> 
				...
				<tr>
					<td>
						<img src="/img/bz.png" style="margin-top: 55px;"/>
					</td>
				</tr>
			</table>
