...
<form method="post" action="/gzps/yjdd/EquipPage@update.page">
	<w:hidden bind="bean.id"/>
	<w:hidden bind="new_"/>
	<div class="ui-formContent">
		<p>
			<label style="width:80px">装备分类：</label>
		...
		<p>
			<label style="width:80px">装备编号：</label>
			<w:text bind="bean.code" style="width:250px"/>
		</p>
		<p>
			<label style="width:80px">装备型号：</label>
			<w:text bind="bean.model" style="width:250px"/>
		</p>
		<p>
			<label style="width:80px">装备名称：</label>
