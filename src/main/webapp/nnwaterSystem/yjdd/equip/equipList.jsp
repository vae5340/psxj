...
<%@taglib uri="/WEB-INF/page-base.tld" prefix="w"%>
 ...
 <form action="/gzps/yjdd/EquipPage@equipList.page" method="post" class="PageForm">
	...
	<table cellpadding="0" cellspacing="0" style="margin-top:5px">
		<tr>
			...
			<td>
				...
				<a href="#" class="easyui-linkbutton" iconCls="icon_add" onclick="addUser('<w:write bind="bean.type"/>')">添加装备</a>
			</td>
		</tr>
		</tr>
	</table>
