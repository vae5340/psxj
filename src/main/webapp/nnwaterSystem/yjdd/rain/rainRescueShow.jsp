...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <style>
	...
	<script>
	function look(code){
		window.parent.$w.openDialog({title:'一雨一报信息',url:ctx+"/gzps/yjdd/RainRescuePage@show.page?id="+code,w:600,h:470});
	}
	</script>
  </head>
	...
	<table class="ui-table" width="100%" cellpadding="1" cellspacing="1" data-options="showPage:true,
		...
		<thead>
				<tr class="ui_th">
	    			...
	    			<th width="70" align="center">查看</th>
				</tr>
			</thead>
			<tbody>
			<w:iterate id="info" bind="resultList_">
				<tr class="ui_td">
				    ...
				    <td style="padding-left:2px;"><button style="width:105px;height:28px;cursor:pointer" onclick="look('<w:write bind="#info.code"/>');return false;"><table><tr><td><img src="<%=path%>/resources/images/icons/16_16/application_form_magnify.png"></td><td>查看</td></tr></table></botton>
				    </td>
				</tr>
			</w:iterate>
			</tbody>
