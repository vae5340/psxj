        ...
        var options,
         ...
         outfallArr=[{"id":1,"x":108.239000,"y":22.843000,"value":70,"combId":84,"name":'a'},
          ...
          use=function(opts){
		      ...
		      backCountArr=[];
		      backStations=[];
              flowSymbolRed = new PictureMarkerSymbol({'url':'/awater/nnwaterSystem/PipeNetwork/img/end-marker.png', 'height':20, 'width':14, 'yoffset': 10}),
              flowSymbolBlue = new PictureMarkerSymbol({'url':'/awater/nnwaterSystem/PipeNetwork/img/target-marker.png', 'height':20, 'width':14, 'yoffset': 10}),
              map=options.map;
          ...
          function showResult(stations,outfallBacks,backCountArr){
		        $.jsPanel({
		            id:'flowbackPanel',
				    contentIframe:{src:"/awater/nnwaterSystem/Alarm/backflow/analysis.html",name:'analysisFrame'},
