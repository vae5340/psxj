...
import com.augurit.agcom.rongyun. io.rong.messages.*;
import com.augurit.agcom.rongyun.io.rong.models.*;
import com.augurit.awater.util.GsonUtil;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "mgb7ka1nmwl8g";//替换成您的appkey
		String appSecret = "5w05688OFTTdGJ";//替换成匹配上面key的secret
...
//		System.out.println("************************User********************");
		// 获取 Token 方法 
		TokenResult userGetTokenResult1 = rongCloud.user.getToken("002f37ae-a6bd-485f-b6d4-df9d5185b413", "黄鹏", "http://www.rongcloud.cn/images/logo.png");
//		System.out.println("getToken:  " + userGetTokenResult1.toString());

		// 获取 Token 方法
		TokenResult userGetTokenResult2 = rongCloud.user.getToken("0074151d-d855-4fe0-aa9c-9661c0f2b9a0", "王卫南", "http://www.rongcloud.cn/images/logo.png");
//		System.out.println("getToken:  " + userGetTokenResult2.toString());

		// 获取 Token 方法
		TokenResult userGetTokenResult3= rongCloud.user.getToken("00ad16eb-abff-481a-9cb8-dc3c0dde4d7b", "刘守学", "http://www.rongcloud.cn/images/logo.png");
//		System.out.println("getToken:  " + userGetTokenResult3.toString());
