...
@Entity
@Table(name = "DRI_TRACK_LINE")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TrackLine implements java.io.Serializable {
	
	// 属性
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_TRACK_LINE", sequenceName="SEQ_DRI_TRACK_LINE", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_TRACK_LINE")
	private Long id;
