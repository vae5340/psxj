package com.augurit.awater.dri.installRecord.entity;
...
@Entity
@Table(name = "DRI_INSTALL_RECORD")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class InstallRecord implements java.io.Serializable {
	
	// 属性
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_INSTALL_RECORD", sequenceName="SEQ_DRI_INSTALL_RECORD", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_INSTALL_RECORD")
	private Long id;
