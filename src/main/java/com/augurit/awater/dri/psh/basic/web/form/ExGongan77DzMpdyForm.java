...
public class ExGongan77DzMpdyForm {
	// 属性
	...
	//栋
	private List<ExShuiwuHousebuildFormForm> buildList;
	
	public List<ExShuiwuHousebuildFormForm> getBuildList() {
		return buildList;
	}

	public void setBuildList(List<ExShuiwuHousebuildFormForm> buildList) {
