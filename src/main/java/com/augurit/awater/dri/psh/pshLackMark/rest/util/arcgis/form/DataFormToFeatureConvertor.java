...
public class DataFormToFeatureConvertor {
	...
	//转成图层实体准备保存
	public static FeatureForm convertLackVoToForm(PshLackMarkForm form) {
		if(form != null) {
			FeatureForm featureForm = new FeatureForm();
			featureForm.setId(form.getId());
			featureForm.setObjectid(StringUtils.isNotBlank(form.getObjectId())?
	 ...
	 * 新增
	 * */
	public static String convertFeatureToMap(PshLackMarkForm lackForm){
	...
	//转成图层实体准备保存
		...
		//转成图层实体准备保存
		public static FeatureUpdateForm convertLackVoToUpdateForm(PshLackMarkForm form) {
			if(form != null) {
				FeatureUpdateForm featureForm = new FeatureUpdateForm();
				featureForm.setId(form.getId());
				featureForm.setObjectid(StringUtils.isNotBlank(form.getObjectId())?
