package com.augurit.awater.dri.psh.menpai.entity;
...
@Entity
@Table(name = "DRI_PSH_MENPAI")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PshMenpai implements java.io.Serializable {
	...
	private String investPersonId;
	
	private Date invertTime;
	...
	public void setInvestPersonId(String investPersonId) {
