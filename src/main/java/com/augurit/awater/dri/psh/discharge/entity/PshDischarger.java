...
@Entity
@Table(name = "DRI_PSH_DISCHARGER")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PshDischarger implements java.io.Serializable {
	
	// 属性
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_PSH_DISCHARGER", sequenceName="SEQ_DRI_PSH_DISCHARGER", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_PSH_DISCHARGER")
	private Long id;
