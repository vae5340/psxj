package com.augurit.awater.dri.psh.pshLackMark.entity;
...
@Entity
@Table(name = "DRI_PSH_LACK_MARK")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PshLackMark implements java.io.Serializable {
	...
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_PSH_LACK_MARK", sequenceName="SEQ_DRI_PSH_LACK_MARK", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_PSH_LACK_MARK")
	private Long id;
