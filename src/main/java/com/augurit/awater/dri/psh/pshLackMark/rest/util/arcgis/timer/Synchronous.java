...
public class Synchronous {
	...
	@Autowired
	public Synchronous(IPshCorrectMarkService correctMarkService){
	 ...
	 * @param userForm
	 * */
	public static String synNotAddFeature(OpuOmUserInfo userForm) {
				...
				if(map!=null&&map.containsKey("parentOrgName")){
					...
					if(listIdsLack!=null && listIdsLack.size()>0){
						...
						for(Object id: listIdsLack){
							PshLackMarkForm lack = correctMarkService.getLackForm(Long.parseLong(id.toString()));
