...
@Entity
@Table(name = "DRI_PS_CORRECT_MARK")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CorrectMark implements java.io.Serializable {
	
	// 属性
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_PS_CORRECT_MARK", sequenceName="SEQ_DRI_PS_CORRECT_MARK", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_PS_CORRECT_MARK")
	private Long id;
