...
public class ReportDelete implements java.io.Serializable {
	...
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_REPORT_DELETE", sequenceName="SEQ_DRI_REPORT_DELETE", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_REPORT_DELETE")
	private Long id;
