...
public class Diary implements java.io.Serializable {
	...
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_DRI_DIARY", sequenceName="SEQ_DRI_DIARY", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_DRI_DIARY")
	private Long id;
