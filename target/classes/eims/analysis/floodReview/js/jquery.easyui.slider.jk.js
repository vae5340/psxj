define(["jquery",'psemgy/eims/analysis/floodReview/js/jkJxss','psemgy/eims/analysis/floodReview/js/jkCsk','mousewheel','customScrollbar','jqueryEasyUI'],
function($,jkJxss,jkCsk){
	...
	*/
	function sliderOnChange(value){
		...
		lastIndex=index;
		jkJxss.changeDemoJXSS(index);
		jkCsk.changeDemoCSK(index);
	...
	*/
	...
	return {
		playbackBtnOnClick: playbackBtnOnClick,
		stopbackBtnOnClick: stopbackBtnOnClick
	}
});