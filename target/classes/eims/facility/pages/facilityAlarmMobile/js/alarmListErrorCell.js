var oTableInit;	
		...
		var xzArea=[];
		$(function(){ 
			xzArea.push({code:'450102',name:'B区'});
			xzArea.push({code:'450103',name:'H区'});
			xzArea.push({code:'450105',name:'A区'});
			xzArea.push({code:'450107',name:'D区'});
			xzArea.push({code:'450108',name:'C区'});
			xzArea.push({code:'450109',name:'E区'});
			xzArea.push({code:'450122',name:'J区'});
			xzArea.push({code:'450123',name:'K区'});
			xzArea.push({code:'450124',name:'L区'});
			xzArea.push({code:'450125',name:'M区'});
			xzArea.push({code:'450126',name:'N区'});
			xzArea.push({code:'450127',name:'O区'});
